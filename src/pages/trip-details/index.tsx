            ...
            <main className="flex gap-16 px-4">
                ...
                <div className="w-80 space-y-8">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    ...
                                    <a className="block text-xs text-zinc-400 truncate hover:text-zinc-200" href="">https://www.airbnb.com.br/rooms/104700011</a>
                                </div>
                        ...
                        <button type="button" className="bg-zinc-800 w-full justify-center  text-zinc-200 rounded-lg h-11 font-medium flex items-center gap-2 hover:bg-zinc-700">
                            <Plus className="size-5" />
                            Cadastrar novo link
                        </button>
                    </div>
